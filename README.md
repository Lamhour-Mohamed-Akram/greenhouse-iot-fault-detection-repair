...
**Status:** Prepared for submission to the International Journal of Prognostics and Health Management (IJPHM). Not yet submitted, accepted, or published; no volume, issue, article number, or DOI exists.
...
@misc{lamhour2026sensorhealth,
  ...
  note={Manuscript prepared for submission to the International Journal of Prognostics and Health Management (IJPHM)}
}
```
